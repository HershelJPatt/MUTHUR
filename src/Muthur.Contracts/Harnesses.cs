...
public sealed record HarnessCandidateDto(string Harness, string Model, string? Account, bool Limited, DateTimeOffset? LimitedUntil, string? ReasoningEffort, int? MaxTurns = null, int? ContextWindow = null);
